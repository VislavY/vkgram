...
fun UnfriendDialog(
    ...
    if (visible.value) {
        AlertDialog(
            ...
            title = {
                Text(
                    text = stringResource(R.string.profile_unfriend_dialog_title),
                    style = VKgramTheme.typography.headlineSmall
                )
            },
            text = {
                Text(
                    text = stringResource(R.string.profile_unfriend_dialog_body, userName),
            ...
            confirmButton = {
                TextButton(
                    ...
                    Text(
                        text = stringResource(R.string.profile_unfriend_dialog_confirm),
            ...
            dismissButton = {
                TextButton(
                    ...
                    Text(
                        text = stringResource(R.string.profile_unfriend_dialog_dismiss),
                        style = VKgramTheme.typography.labelLarge
                    )
                }
            },
